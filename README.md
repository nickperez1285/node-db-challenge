...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    SQL is the language or code used to build a relational database. SQL allows you to query the information stored in a Relational Database
- [ ] Why do tables need a `primary key`?
    primary keys are what identify the unique input 
